...
void main() {
  ...
  float frequency = remap(complexity, 0.0, 1.0, 0.1, 1.2);
  ...
  float amplitude2 = 4.0 * (1.0 - (1.0 - radiusHeightLocalScale) * (1.0 - radiusHeightLocalScale)); //remaping 0..1 to 3..14 radius of original halo

  float horizontalFrequency = complexity * 1.5;
  float horizontalAmplitude = amplitude2 * complexity * 1.0; //remaping 0..1 to 3..14 radius of original halo
  ...
  float perlin1 = 0.5 + 0.5 * cnoise2( horizontalNoiseDir );
  float perlin2 = 0.5 + 0.5 * cnoise2( horizontalNoiseDir2 );
  float perlin3 = 0.5 + 0.5 * cnoise2( wobbleDir );
