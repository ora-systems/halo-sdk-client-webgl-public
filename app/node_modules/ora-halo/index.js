...
function Halo(opts) {
  this.maxRingRadius = 0.1;
  this.minRingRadius = 1.0;
  this.minNumRings = 1;
  this.maxNumRings = 50;
  this.size = 0.7;
...
Halo.prototype.buildMesh = function(opts) {
  ...
  var tex = Texture2D.load(opts.lineTexture, { repeat: true, mipmap: true });
  var mat = new HaloRingMaterial({ lineTexture: tex } );
...
Halo.prototype.update = function() {
  ...
  for(var i=0; i<numRings; i++) {
    ...
    ring.uniforms.radius = remap(i, 0, numRings, this.minRingRadius, this.maxRingRadius);
    ring.uniforms.radiusHeightScale = remap(i, 0, numRings, 0, 1);
    //ring.uniforms.radius = 1.0;
  }
