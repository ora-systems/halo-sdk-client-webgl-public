...
Halo.prototype.updateGeometry = function(mode) {
  ...
  return new Mesh(g, this.material, { lines: true });
}
...
Halo.prototype.animate = function() {
  for(var i=0; i<this.ringInstances.length; i++) {
    ...
    if (ring.uniforms.horizontalOffset < 5)
      ring.uniforms.horizontalOffset  += Time.delta * ring.uniforms.speed;
    else {
      ring.uniforms.horizontalOffset -= 5.0
    }
    if (ring.uniforms.horizontalOffset2 < 5)
      ring.uniforms.horizontalOffset2  += Time.delta * ring.uniforms.speed;
    else {
      ring.uniforms.horizontalOffset2 -= 5.0
    }
