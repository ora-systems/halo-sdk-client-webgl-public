...
Halo.prototype.updateParams = function() {
  ...
  while(this.ringInstances.length < numRings) {
    ...
    this.ringInstances.push({
      uniforms: {
        ...
        complexity: 0,
        speed: 0.5,
        time: 0,//lastRing ? lastRing.time : 0,
        alpha: 0,
        brightness: 1
      },
      uniformsTargets: {
  ...
  console.log('this.maxRingRadius', this.maxRingRadius);
...
Halo.prototype.animate = function() {
  for(var i=0; i<this.ringInstances.length; i++) {
    ...
    ring.uniforms.alpha       += (ring.uniformsTargets.alpha - ring.uniforms.alpha) * 0.1;
