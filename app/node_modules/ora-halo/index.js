...
Halo.prototype.animate = function() {
  for(var i=0; i<this.ringInstances.length; i++) {
    ...
    ring.uniforms.radiusHeightScale = pow(remap(i, 0, this.maxNumRings, 0, 1), 2);
    ring.uniforms.radiusHeightLocalScale = pow(remap(i, 0, this.ringInstances.length, 0, 1), 2);
