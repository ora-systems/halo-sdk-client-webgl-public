...
Halo.prototype.updateTimelineGeometry = function() {
  ...
  var texCoords = centerPoints.map(function(v, i) { return new Vec2(i/(centerPoints.length-1), 0)});

  for(var i=0; i<numPoints; i++) {
    var center = centerPoints[i];
    centerPoints.push(center); //duplicate them
    var p1 = center.dup();
    var p2 = center.dup();
    p1.scale(1/0.95);
    p2.scale(0.95);
  ...
  var g = new Geometry({ vertices: points, normals2: centerPoints, texCoords: texCoords, faces: faces  });
