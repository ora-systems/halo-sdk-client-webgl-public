...
Halo.prototype.animate = function() {
  for(var i=0; i<this.ringInstances.length; i++) {
    ...
    ring.uniforms.time        = this.stratified ? 0 : this.time;
    ...
    ring.uniforms.horizontalOffset =  this.stratified ? 0 : 5 * (seconds/5 - Math.floor(seconds/5));
    ring.uniforms.horizontalOffset2  = this.stratified ? 0 : 5 * ((seconds + 2.5)/5 - Math.floor((seconds + 2.5)/5));
