...
Halo.prototype.update = function() {
    ...
    this.rotation += this.rotationSpeed * this.window.getTime().getDeltaSeconds()
    this.wobbleTime += speed * this.window.getTime().getDeltaSeconds();
...
Halo.prototype.animate = function() {
  for(var i=0; i<this.ringInstances.length; i++) {
    ...
    ring.uniforms.wobbleTime  = this.wobbleTime;
...
Halo.prototype.draw = function(camera, camera2D, w, h) {
  ...
  ctx.rotate(-this.rotation, [0, 1, 0])
