...
function Halo(opts) {
  ...
  this.minCycles = 10;
  this.maxCycles = 20;
  this.stratifiedAmplitude = 0.5;
  this.minRingWidth = 0.02;
  this.maxRingWidth = 0.2;
  this.compactness = 1;
  this.timelineTransparency = true;
  this.alpha = 1;
...
Halo.prototype.setRingParam = function(ringIndex, param, value) {
  var inst = this.ringInstances[ringIndex];
  if (inst) {
    inst.uniforms[param] = value;
    inst.uniformsTargets[param] = value;
  }
  else if (ringIndex == -1) {
    this.ringInstances.forEach(function(inst) {
      inst.uniforms[param] = value;
      inst.uniformsTargets[param] = value;
    })
  }
...
Halo.prototype.animate = function() {
  for(var i=0; i<this.ringInstances.length; i++) {
    ...
    ring.uniforms.globalAlpha = this.alpha;
