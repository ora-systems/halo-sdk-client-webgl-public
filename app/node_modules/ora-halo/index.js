...
Halo.prototype.buildMesh = function(opts) {
  ...
  this.gridMaterial = new HaloRingMaterial({ lineTexture: lineSolidTexture, colorTexture: gridColorTexture } );
...
Halo.prototype.updateGridLines = function() {
  ...
  for(var i=0; i<numGridLines; i++) {
    this.gridLineInstances.push({
      uniforms: {
        radius: remap(i, 0, numGridLines-1, this.minRingRadius, this.maxRingRadius),
        color: 0,
        colorCenter: 0,
        colorCenterRatio: 0,
        complexity: 0,
